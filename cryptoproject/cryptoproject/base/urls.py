...
from .views import home, user_register, user_login, two_factor_authenticate, user_logout, view_public_key, upload_and_encrypt, list_of_encrypted_file, decrypt_file, navigator
urlpatterns = [
